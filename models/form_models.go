...
type Form struct {
	...
	Document_UUID string         `json:"document_uuid" db:"document_uuid" validate:"required"`
	User_id       string         `json:"user_id" db:"user_id" validate:"required"`
	Form_number   string         `json:"form_number" db:"form_number" validate:"required"`
	Form_ticket   string         `json:"form_ticket" db:"form_ticket" validate:"required"`
	Form_status   string         `json:"form_status" db:"form_status"`
